...
class CWMachine(StateMachine):
    ...
    def toggleMessage(self):
        ...
        # Check what the current messae is, then set it to the other message so we can switch
    ...
    def transmit(self):
        ...
        while not self.endTransmission:
            ...
            for word in wordList:
                ...
                for char in word:
                    ...
                    for x in morse:
                        ...
                        ## Dot or dash? Display the appropriate dot or dash
                        if x == '-':
                            self.doDash()
                            self.doDash()
                        elif x == '.':
            ...
            # I want to add a space between the time it repeats the message every time
            self.doWP()
            self.doWP()
...
# when the button is pressed, execute the process button function
